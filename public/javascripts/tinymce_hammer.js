...
window.tinyMCEPreInit = {
  base : '/javascripts/tiny_mce',
  suffix : '',  
  query : ''
}
window.tinyMCE_GZ = { loaded : true };(function(win) {
...
}(tinymce));tinyMCE.addI18n('en.advanced',{
style_select:"Styles",
font_size:"Font size",
...
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/langs/en.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/themes/advanced/editor_template_src.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/themes/advanced/langs/en.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/plugins/paste/editor_plugin_src.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/plugins/table/editor_plugin_src.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/plugins/contextmenu/editor_plugin_src.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/plugins/fullscreen/editor_plugin_src.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/plugins/asciimath/langs/en.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/plugins/asciisvg/langs/en.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/plugins/visualchars/editor_plugin_src.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/plugins/safari/editor_plugin_src.js'));
tinymce.ScriptLoader.markDone(tinyMCE.baseURI.toAbsolute('/javascripts/tiny_mce/plugins/inlinepopups/editor_plugin_src.js'));