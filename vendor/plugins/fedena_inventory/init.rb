...
FedenaPlugin.register = {
  ...
  :sub_menus=>[ {:title=>"store_category",:controller=>"store_categories",:action=>"index",:target_id=>"fedena_inventory"},
    ...
    {:title=>"supplier type",:controller=>"supplier_types",:action=>"index",:target_id=>"fedena_inventory"},
    ...
    {:title=>"purchase order",:controller=>"purchase_orders",:action=>"index",:target_id=>"fedena_inventory"},
